...
probe_set["Rating"].to_csv("data/real_mu_probe.txt", header=None, index=False, sep=' ')
print(len(probe_set))
...
mu_train["Rating"].to_csv("data/real_mu_train.txt", header=None, index=False, sep=' ')
print(len(mu_train))
...
probe_set["Rating"].to_csv("data/real_um_probe.txt", header=None, index=False, sep=' ')
...
um_train["Rating"].to_csv("data/real_um_train.txt", header=None, index=False, sep=' ')
print(len(um_train))
